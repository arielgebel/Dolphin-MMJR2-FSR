...
public enum IntSetting implements AbstractIntSetting
{
  ...
  MAIN_IR_MODE(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID, "IRMode",
    ...
    GESTURE_LEFT_TAP(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_GESTURES,
      "GestureLeftTap", 0),
    GESTURE_LEFT_DOUBLE_TAP(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_GESTURES,
      "GestureLeftDoubleTap", 0),
    GESTURE_LEFT_SWIPE_UP(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_GESTURES,
      "GestureLeftSwipeUp", 0),
    GESTURE_LEFT_SWIPE_DOWN(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_GESTURES,
      "GestureLeftSwipeDown", 0),
    GESTURE_LEFT_SWIPE_LEFT(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_GESTURES,
      "GestureLeftSwipeLeft", 0),
    GESTURE_LEFT_SWIPE_RIGHT(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_GESTURES,
      "GestureLeftSwipeRight", 0),
    GESTURE_RIGHT_TAP(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_GESTURES,
      "GestureRightTap", 0),
    GESTURE_RIGHT_DOUBLE_TAP(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_GESTURES,
      "GestureRightDoubleTap", 0),
    GESTURE_RIGHT_SWIPE_UP(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_GESTURES,
      "GestureRightSwipeUp", 0),
    GESTURE_RIGHT_SWIPE_DOWN(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_GESTURES,
      "GestureRightSwipeDown", 0),
    GESTURE_RIGHT_SWIPE_LEFT(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_GESTURES,
